...
const Postcard = ({ post }) => {
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <h1 className="transition duration-700 text-black text-center text-3xl font-semibold mb-8 cursor-pointer hover:text-fuchsia-600">
      ...
      <p className="text-gray-700 px-4 lg:px-20 mb-8 text-center text-lg font-normal">
        {post.excerpt}
      </p>
